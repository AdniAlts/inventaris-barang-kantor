    ...
    <div class="flex h-screen">
        <aside class="w-60 bg-white text-gray-700 flex flex-col shadow-lg">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <a href="/inventaris-barang-kantor/jenis" class="sidebar-link active flex items-center px-4 py-3 text-gray-600 rounded-lg">
                        ...
                        <tbody>
                            <?php if (!empty($jenis_list)): ?>
                                ...
                                <tr class="bg-white border-b hover:bg-blue-50">
                                    <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap"><?php echo htmlspecialchars($jenis['id_jenis']); ?></td>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr><td colspan="5" class="px-6 py-4 text-center text-gray-500">Belum ada jenis atau gagal memuat data.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    ...
                    <div class="grid gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="nama_jenis" id="nama_jenis_add" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Contoh: Laptop Dell" required>
                        </div>
                        <div>
                            <label for="stok_add" class="block mb-2 text-sm font-medium text-gray-900">Stok</label>
                            <input type="number" name="stok" id="stok_add" min="0" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="0" value="0">
                        </div>
                        <div>
                            <label for="kategori_id_add" class="block mb-2 text-sm font-medium text-gray-900">Kategori</label>
                            <select name="kategori_id" id="kategori_id_add" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" required>
        ...
        <div class="relative p-4 w-full max-w-2xl md:h-auto">
            <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    ...
                    <div class="grid gap-4 mb-4">
                        <div>
                            <label for="nama_jenis_edit" class="block mb-2 text-sm font-medium text-gray-900">Nama Jenis</label>
                            <input type="text" name="nama_jenis_edit" id="nama_jenis_edit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                        </div>
                        <div>
                            <label for="stok_edit" class="block mb-2 text-sm font-medium text-gray-900">Stok</label>
                            <input type="number" name="stok_edit" id="stok_edit" min="0" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                        </div>
                        <div>
                            <label for="kategori_id_edit" class="block mb-2 text-sm font-medium text-gray-900">Kategori</label>
                            <select name="kategori_id_edit" id="kategori_id_edit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" required>
                                <option value="">Pilih Kategori</option>
                                <?php foreach ($categories as $category): ?>
                                    <option value="<?php echo htmlspecialchars($category['id_kategori']); ?>">
                                        <?php echo htmlspecialchars($category['nama']); ?>
