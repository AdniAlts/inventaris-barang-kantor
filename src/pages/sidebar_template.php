    ...
    <div class="h-full grid content-between px-3 py-4 overflow-y-auto overflow-x-hidden bg-gray-50">
      <div class="self-start">
        ...
        <ul class="pt-4 mt-4 space-y-2 font-semibold border-t border-gray-200">
          <li>
            <a href="#"
              class="flex items-center p-2 secondary-color rounded-lg bg-indigo-100 boxring ring-indigo-300 group">
          ...
          <li>
            <a href="#" class="flex items-center p-2 secondary-color rounded-lg hover:bg-gray-100 group">
              <svg class="shrink-0 w-5 h-5 primary-color transition duration-75 group-hover:primary-color"
        ...
        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200">
          <li>
            <a href="#" class="flex items-center p-2 text-gray-600 rounded-lg  hover:bg-gray-100 group">
