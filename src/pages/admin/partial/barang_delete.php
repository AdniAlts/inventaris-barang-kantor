<div id="delete-barang-modal" class="fixed inset-0 flex items-center justify-center edit-modal-backdrop hidden delete-modal-backdrop  opacity-0 transition-opacity duration-500 ease-in-out">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 w-11/12 max-w-md mx-auto transform transition-all duration-300 scale-95 opacity-0 delete-modal-content">
        <div class="flex justify-between items-center mb-6">
            <h3 class="text-2xl font-bold text-red-600 dark:text-red-500">Confirm Deletion</h3>
            <button type="button" id="close-delete-modal" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white">
        ...
        <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg mb-6 flex flex-col sm:flex-row items-center gap-4">
            <img id="delete-item-image" src="" alt="Item to be deleted" class="rounded-lg w-20 h-20 object-cover flex-shrink-0 border border-gray-300 dark:border-gray-600">
            <div class="flex-grow text-center sm:text-left">
                <p class="font-bold text-lg text-gray-900 dark:text-white" id="delete-item-codename"></p>
                <p class="text-sm text-gray-600 dark:text-gray-400" id="delete-item-condition"></p>
                <p class="text-sm text-gray-600 dark:text-gray-400" id="delete-item-status"></p>
            </div>
        </div>
