...
<body>
  ...
  <main class="p-4 sm:ml-64 main-content transition-margin duration-300">
    <div>
      <p>TOLONG BACA AKU!!!</p>
      <p>Ini bisa jadi saran untuk membantu pembuatan kondisi:</p>
      <ol style="list-style: decimal;">
        ...
        <li>Boleh pake referensi halaman yang mirip sebelumnya, linknya bisa buka <a href="<?= Helper::basePath(); ?>src/pages/old/state.php" style="text-decoration: underline;">di sini</a>.</li>
        <li>Kolom tabel yang ditampilkan bisa berupa id kondisi, nama kondisi, sama aksi CRUD nya.</li>
        <li>Mungkin tambahan kode barang apa saja yang bersangkutan dengan kondisi itu.</li>
